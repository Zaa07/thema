...
check_token() {
  echo -e "                                                       "
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BLUE}[+]               LICENSY Rizz OFFC             [+]${NC}"
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  echo -e "${YELLOW}MASUKAN AKSES TOKEN :${NC}"
  read -r USER_TOKEN

  if [ "$USER_TOKEN" = "novacantik" ]; then
    echo -e "${GREEN}AKSES BERHASIL${NC}}"
  else
    echo -e "${GREEN}Buy dulu Gih Ke Rizz${NC}"
    echo -e "${YELLOW}TELEGRAM : @riznov79${NC}"
    echo -e "${YELLOW}WHATSAPP : 6282253595771${NC}"
    echo -e "${YELLOW}HARGA TOKEN : 10K FREE UPDATE JIKA ADA TOKEN BARU${NC}"
    echo -e "${YELLOW}©RizzOffc${NC}"
    exit 1
  fi
  clear
}
...
install_theme() {
  while true; do
    ...
    case "$SELECT_THEME" in
      1)
        THEME_URL=$(echo -e "https://github.com/Zaa07/thema/raw/main/C2.zip")
        break
        ;;
      2)
        ...
        ;;
      3)
        THEME_URL=$(echo -e "https://github.com/Zaa07/thema/raw/main/C3.zip")
        break
        ;; 
      x)
        return
...
uninstall_theme() {
  ...
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  bash <(curl https://raw.githubusercontent.com/Zaa07/thema/main/repair.sh)
  echo -e "                                                       "
  echo -e "${GREEN}[+] =============================================== [+]${NC}"
...
# Unduh file tema
wget -O /root/C2.zip https://github.com/Zaa07/thema/raw/main/C2.zip
...
while true; do
  clear
  echo -e "                                                                     "
  echo -e "${RED}    NNNNNNNN        NNNNNNNN                                      ${NC}"
  echo -e "${RED}    N:::::::N       N::::::N                                   ${NC}"
  echo -e "${RED}    N::::::::N      N::::::N                               ${NC}"
  echo -e "${RED}    N:::::::::N     N::::::N                             ${NC}"
  echo -e "${RED}    N::::::::::N    N::::::N                          ${NC}"
  echo -e "${RED}    N:::::::::::N   N::::::N            Auto Installer Rizz   ${NC}"
  echo -e "${RED}    N:::::::N::::N  N::::::N            ------------------------  ${NC}"
  echo -e "${RED}    N::::::N N::::N N::::::N            • Telegram : @riznov79      ${NC}"
  echo -e "${RED}    N::::::N  N::::N:::::::N            • Creadit  : RizzOFFC  ${NC}"
  echo -e "${RED}    N::::::N   N:::::::::::N            • Support by RizzOffc  ${NC}"
  echo -e "${RED}    N::::::N    N::::::::::N                                        ${NC}"
  echo -e "${RED}    N::::::N     N:::::::::N                                                 ${NC}"
  echo -e "${RED}    N::::::N      N::::::::N                                                ${NC}"
  echo -e "${RED}    N::::::N       N:::::::N                                                  ${NC}"
  echo -e "${RED}    N::::::N        N::::::N                                                 ${NC}"
  echo -e "${RED}    NNNNNNNN         NNNNNNN                                                  ${NC}"
  echo -e "                                                                     "
