...
while true; do
  ...
  echo -e "${RED}'ggg      ,gg'''  .    ggg       Auto Installer Rizz   ${NC}"
  echo -e "${RED}gggg      gg     ,     ggg      ------------------------  ${NC}"
  echo -e "${RED}ggg:     gg.     -   ,ggg       • Telegram : @riznov79      ${NC}"
  echo -e "${RED} ggg:     ggg._    _,ggg        • Creadit  : RizzOFFC  ${NC}"
  echo -e "${RED} ggg.    '.'''ggggggp           • Support by RizzOffc  ${NC}"
